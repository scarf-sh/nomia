...
#+OPTIONS: H:5
#+OPTIONS: toc:nil
Scarf's strategy centers around a unified package distribution platform and capturing analytics for maintainers. This document introduces elvysh, a technical system that can provide the underpinnings of those capabilities and help ensure a Scarf program on every machine.
