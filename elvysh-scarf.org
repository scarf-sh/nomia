...
#+OPTIONS: H:5
#+OPTIONS: toc:nil
Scarf's strategy centers around a unified package distribution platform and providing analytics to maintainers. This document introduces a system, provisionally named elvysh, that can provide the foundations of those capabilities in a way that encourages a Scarf tool on every machine.
