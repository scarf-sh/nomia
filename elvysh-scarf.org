...
+ Elvysh's observability can be leveraged to collect information about how and where different packages are used; Scarf's collection of that information can guide elvysh's development to best meet the goals of its users
...
** TODO M Expected user knowledge/background for various use cases
(incl setup/config)
** TODO M Expected interface with Elvysh core
** TODO M Accompanying infrastructure
* TODO Project plan
